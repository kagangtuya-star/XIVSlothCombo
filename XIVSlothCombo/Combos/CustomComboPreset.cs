...
namespace XIVSlothCombo.Combos
{
    ...
    public enum CustomComboPreset
    {
        ...
        [CustomComboInfo("全局治疗职业功能", "Features and options involving shared role actions for Healers.\nCollapsing this category does NOT disable the features inside.", ADV.JobID)]
        ...
        [CustomComboInfo("全局远程魔法进攻职业功能", "Features and options involving shared role actions for Magical Ranged DPS.\nCollapsing this category does NOT disable the features inside.", ADV.JobID)]
        ...
        [CustomComboInfo("全局近战进攻职业功能", "Features and options involving shared role actions for Melee DPS.\nCollapsing this category does NOT disable the features inside.", ADV.JobID)]
        ...
        [CustomComboInfo("全局物理远程职业功能", "Features and options involving shared role actions for Physical Ranged DPS.\nCollapsing this category does NOT disable the features inside.", ADV.JobID)]
        ...
        AST_ST_DPS = 1004,
            ...
            [CustomComboInfo("烧灼上线选项", "添加 Combust to the DPS feature if it's not present on current target, or is about to expire.", AST.JobID, 0, "", "")]
        ...
        AST_AoE_SimpleHeals_AspectedHelios = 1010,
            ...
            [ParentCombo(AST_AoE_SimpleHeals_AspectedHelios)]
            [CustomComboInfo("Lazy Lady Option", "添加 Lady of Crowns, if the card is drawn", AST.JobID)]
        ...
        [ParentCombo(BLM_SimpleMode)]
        [CustomComboInfo("冷却选项", "添加 Manafont, Sharpcast, Amplifier onto the Simple BLM feature.", BLM.JobID, 0, "", "")]
        ...
        [CustomComboInfo("月之笛起手连击", "月之笛起手连击放置于月之笛或口笛上", BLU.JobID)]
        BLU_Opener = 70001,
        ...
        [CustomComboInfo("生成外设-芥末爆弹", "当目标受到头晕的影响时，将生成外设变为芥末爆弹。", BLU.JobID)]
        ...
        [ParentCombo(BLU_PrimalCombo)]
        [CustomComboInfo("Sea Shanty Option", "添加 Sea Shanty to the Primal Feature.", BLU.JobID)]
        BLU_PrimalCombo_SeaShanty = 70024,

        [BlueInactive(BLU.WingedRepropbation)]
        [ParentCombo(BLU_PrimalCombo)]
        [CustomComboInfo("Winged Reprobration Option", "添加 Winged Reprobation to the Primal Feature.", BLU.JobID)]
        ...
        [CustomComboInfo("伶牙俐齿续dot模式A", "Iron Jaws is replaced with Caustic Bite/Stormbite if one or both are not up.\nAlternates between the two if Iron Jaws isn't available.", BRD.JobID, 0, "", "")]
        BRD_IronJaws = 3003,

        [ReplaceSkill(BRD.IronJaws)]
        [ConflictingCombos(BRD_IronJaws)]
        [CustomComboInfo("伶牙俐齿续dot模式B", "Iron Jaws is replaced with Caustic Bite/Stormbite if one or both are not up.\nIron Jaws will only show up when debuffs are about to expire.", BRD.JobID, 0, "", "")]
        ...
        [ParentCombo(BRD_ST_SimpleMode)]
        [CustomComboInfo("防止资源浪费相关选项", "添加 enemy health checking on mobs for buffs, DoTs and Songs.\nThey will not be reapplied if less than specified.", BRD.JobID, 0, "", "")]
        ...
        [ConflictingCombos(DNC_ST_SimpleMode, DNC_AoE_SimpleMode)]
        [CustomComboInfo("跳舞功能", "Features and options involving Standard Step and Technical Step.\nCollapsing this category does NOT disable the features inside.", DNC.JobID, 0, "", "")]
        DNC_Dance_Menu = 4020,
        ...
        [CustomComboInfo("血溅 设置", "添加 Bloodspiller when Delirium is active.", DRK.JobID, 0, "", "")]
        ...
        [CustomComboInfo("暗影使者 设置", "添加 Shadowbringer to oGCD Feature ", DRK.JobID, 0, "", "")]
        ...
        [ParentCombo(DRK_SouleaterCombo)]
        [CustomComboInfo("伤残特性", "当你离开近战范围时使用伤残替换主连击。", DRK.JobID, 0, "", "")]
        ...
        [CustomComboInfo("近战时使用跳斩 设置", "Uses Plunge when under Darkside and in the target ring (1 yalm).\nWill use as many stacks as selected in the above slider.", DRK.JobID, 0, "", "")]
        DRK_MeleePlunge = 5023,

        [ParentCombo(DRK_MainComboCDs_Group)]
        [CustomComboInfo("腐秽大地特性", "添加 Salted Earth on main combo while Darkside is up, will use Salt and Darkness if unlocked.", DRK.JobID, 0, "", "")]
        ...
        DRG_STCombo = 6100,
            ...
            [ParentCombo(DRG_ST_CDs)]
            [CustomComboInfo("跳跃选项", "添加 Spineshatter Dive, Dragonfire Dive, and Stardiver to the rotation.\n Select options below for when to use dives.", DRG.JobID, 14, "", "")]
            DRG_ST_Dives = 6104,
            ...
            [ParentCombo(DRG_STCombo)]
            [CustomComboInfo("回复设置", "添加 Bloodbath and Second Wind to the combo, using them when below the HP Percentage threshold.", DRG.JobID, 0, "", "")]
        ...
        [CustomComboInfo("巨龙视线选项", "添加 Dragon Sight to Lance Charge, will take precedence over Battle Litany.", DRG.JobID, 26, "", "")]
        ...
        [ParentCombo(GNB_GF_Continuation)]
        [CustomComboInfo("烈牙CD选项", "添加 Bloodfest/Sonic Break/Bow Shock/Blasting Zone on Gnashing Fang, order dependent on No Mercy buff.\nBurst Strike and Hypervelocity added if there's charges while No Mercy buff is up.", GNB.JobID, 0, "", "")]
        ...
        [CustomComboInfo("交替插入钻头/空气锚/热弹被添加到连击循环中", "Drill/Air/Hotshot Feature is added onto main combo (Note: It will add them onto main combo ONLY if you are under Reassemble Buff\nOr Reasemble is on CD (will do nothing if Reassemble is OFF CD)", MCH.JobID, 0, "", "")]
        ...
        [ParentCombo(MCH_ST_MainCombo)]
        [CustomComboInfo("弹射 & 虹吸弹 设置", "添加 Ricochet and Gauss Round to main combo.\nWill use all charges.", MCH.JobID, 0, "", "")]
        MCH_ST_MainCombo_RicochetGaussCharges = 8017,

        [ConflictingCombos(MCH_ST_MainCombo_RicochetGaussCharges)]
        [ParentCombo(MCH_ST_MainCombo)]
        [CustomComboInfo("Ricochet & Gauss Round Overcap Protection Option", "添加 Ricochet and Gauss Round to main combo.\nWill leave 1 charge of each.", MCH.JobID, 0, "", "")]
        ...
        [CustomComboInfo("野火 设置", "添加 Wildfire to the Single Button Heat Blast Feature if Wildfire is off cooldown and you have enough Heat Gauge for Hypercharge then Hypercharge will be replaced with Wildfire.\nAlso weaves Ricochet/Gauss Round on Heat Blast when necessary.", MCH.JobID, 0, "", "")]
        MCH_ST_Wildfire = 8015,

        [ParentCombo(MCH_AoE_SimpleMode)]
        [CustomComboInfo("毒菌冲击整合 设置", "添加 Bioblaster to the feature", MCH.JobID, 0, "", "")]
        ...
        [ParentCombo(MCH_AoE_SimpleMode)]
        [CustomComboInfo("回转飞锯", "添加 Chain Saw to the feature.", MCH.JobID)]
        MCH_AoE_ChainSaw = 8041,

        [ParentCombo(MCH_AoE_SimpleMode)]
        [CustomComboInfo("整备aoe设置", "在习得毒菌冲击之前，整备仅散射一起使用.", MCH.JobID)]
        MCH_AoE_Simple_Assembling = 8042,

        [ParentCombo(MCH_AoE_Simple_Assembling)]
        [CustomComboInfo("回转飞锯", $"当可以的时候整备与回转飞锯一起使用.", MCH.JobID)]
        MCH_AoE_Simple_Assembling_ChainSaw = 8043,

        [ParentCombo(MCH_AoE_Simple_Assembling_ChainSaw)]
        [CustomComboInfo("回转飞锯合并选项", "仅在 整备 达到最大积蓄次数时才使用 回转飞锯", MCH.JobID)]
        MCH_AoE_Simple_Assembling_ChainSaw_MaxCharges = 8044,

        [ParentCombo(MCH_AoE_Simple_Assembling)]
        [CustomComboInfo("毒菌冲击选项", $"当可以的时候整备与毒菌冲击一起使用", MCH.JobID)]
        MCH_AoE_Simple_Assembling_Bioblaster = 8045,

        [ParentCombo(MCH_AoE_Simple_Assembling_Bioblaster)]
        [CustomComboInfo("毒菌冲击合并选项", "仅在 整备 达到最大积蓄次数时才使用 毒菌冲击", MCH.JobID)]
        ...
        [ParentCombo(MNK_ST_SimpleMode)]
        [CustomComboInfo("回复设置", "添加 Bloodbath and Second Wind to the combo, using them when below the HP Percentage threshold.", MNK.JobID, 0, "", "")]
        ...
        [CustomComboInfo("下忍模式 - 单目标", "Replaces Spinning Edge with a one-button full single target rotation.\nThis is the ideal option for newcomers to the job.", NIN.JobID)]
        ...
        [CustomComboInfo("上忍模式 - 单目标", "Replace Spinning Edge with a one-button full single target rotation.\nThese features are ideal if you want to customize the rotation.", NIN.JobID)]
        ...
        [CustomComboInfo("上忍模式 - AoE", "Replace Death Blossom with a one-button full AoE rotation.\nThese features are ideal if you want to customize the rotation.", NIN.JobID)]
        ...
        [CustomComboInfo("攻其不备 替换 生杀予夺", "Replaces Kassatsu with Trick Attack while Suiton or Hidden is up.\nCooldown tracking plugin recommended.", NIN.JobID)]
        NIN_KassatsuTrick = 10054,

        [ReplaceSkill(NIN.TenChiJin)]
        [CustomComboInfo("命水 替换 天地人", "Replaces Ten Chi Jin (the move) with Meisui while Suiton is up.\nCooldown tracking plugin recommended.", NIN.JobID)]
        NIN_TCJMeisui = 10055,
        ...
        [CustomComboInfo("骑士高级模式 - 单目标", $"自定义输出(先锋剑)Replaces Fast Blade with a one-button full single target rotation.\nThis is ideal for newcomers to the job.", PLD.JobID)]
        PLD_ST_SimpleMode = 11000,

        [ConflictingCombos(PLD_AoE_AdvancedMode)]
        [ReplaceSkill(PLD.TotalEclipse)]
        [CustomComboInfo("骑士高级模式 - AoE", $"一键输出(全蚀斩) Replaces Total Eclipse with a one-button full AoE rotation.\nThis is ideal for newcomers to the job.", PLD.JobID)]
        PLD_AoE_SimpleMode = 11001,

        [ConflictingCombos(PLD_ST_SimpleMode)]
        [ReplaceSkill(PLD.FastBlade)]
        [CustomComboInfo("骑士简单模式 - 单目标", $"一键输出(先锋剑)Replaces Fast Blade with a one-button full single target rotation.\nThese features are ideal if you want to customize the rotation.", PLD.JobID)]
        ...
        [ParentCombo(PLD_ST_AdvancedMode)]
        [CustomComboInfo("投盾选项", "添加 Shield Lob 到自定义循环 if out of range.", PLD.JobID)]
        ...
        [ParentCombo(PLD_ST_AdvancedMode)]
        [CustomComboInfo("恕罪剑选项", "添加 恕罪剑 到自定义循环", PLD.JobID)]
        ...
        [ReplaceSkill(PLD.TotalEclipse)]
        [CustomComboInfo("骑士高级模式 - AoE", $"自定义循环链(全蚀斩)Replaces Total Eclipse with a one-button full AoE rotation.\nThese features are ideal if you want to customize the rotation.", PLD.JobID)]
        ...
        [ParentCombo(RPR_ST_SliceCombo)]
        [CustomComboInfo("死亡之影设置", "添加 Shadow of Death to Slice Combo if Death's Design is not present on current target, or is about to expire.", RPR.JobID, 0, "", "")]
        ...
        [ParentCombo(RPR_ST_SliceCombo)]
        [CustomComboInfo("回复设置", "添加 Bloodbath and Second Wind to the combo at 65%% and 40%% HP, respectively.", RPR.JobID, 0, "", "")]
        ...
        [ParentCombo(RPR_ST_SliceCombo)]
        [CustomComboInfo("暴食与隐匿挥割设置", "添加 Gluttony and Blood Stalk to the combo when target is afflicted with Death's Design, and the skills are off cooldown and < 50 soul.", RPR.JobID, 0, "", "")]
        ...
        [ParentCombo(RPR_AoE_ScytheCombo)]
        [CustomComboInfo("死亡之涡设置", "添加 Whorl of Death to AoE combo if Death's Design is not present on current target, or is about to expire.", RPR.JobID, 0, "", "")]
        RPR_AoE_ScytheCombo_WoD = 12022,

        [ParentCombo(RPR_AoE_ScytheCombo)]
        [CustomComboInfo("断首设置", "添加 Guillotine to AoE combo when under Soul Reaver and when current target is afflicted with Death's Design.\nWill use Grim Reaping during Enshroud.", RPR.JobID, 0, "", "")]
        ...
        [CustomComboInfo("绞决/缢杀/断首替换隐匿挥割/束缚挥割功能", "添加 Gibbet and Gallows on Blood Stalk.\nAdds Guillotine on Grim Swathe.", RPR.JobID, 0, "", "")]
        RPR_GluttonyBloodSwathe_BloodSwatheCombo = 12040,

        [ParentCombo(RPR_GluttonyBloodSwathe)]
        [CustomComboInfo("夜游魂衣连击设置", "添加 Enshroud combo (Void/Cross Reaping, Communio, and Lemure's Slice) on Blood Stalk and Grim Swathe.", RPR.JobID, 0, "", "")]
        ...
        [CustomComboInfo("真北 开关", "添加 True North to Slice, Shadow of Death, Enshroud, and Blood Stalk when under Gluttony and if Gibbet/Gallows options are selected to replace those skills.", RPR.JobID, 0)]
        RPR_TrueNorth = 12061,
        ...
        */
        ...
        [CustomComboInfo("单体输出设置","Enables various Single Target options below.", RDM.JobID, 1)]
        RDM_ST_DPS = 13000,

            [ParentCombo(RDM_ST_DPS)]
            [CustomComboInfo("平衡魔元选项（90级）Balance Opener Option [Lv.90]", "在近战连击前必须移动到近战范围内**", RDM.JobID, 110)]
            RDM_Balance_Opener = 13110,

                [ParentCombo(RDM_Balance_Opener)]
                [CustomComboInfo("无视魔元选项", "Removes 0/0 Mana reqirement to reset opener\n**其他选项必须不设置cd**", RDM.JobID, 111)]
                RDM_Balance_Opener_AnyMana = 13111,

            [ParentCombo(RDM_ST_DPS)]
            [CustomComboInfo("赤x雷/赤x风设置 ", "将摇荡替换为赤x雷/赤x风.", RDM.JobID, 210)]
            RDM_ST_ThunderAero = 13210,

                [ParentCombo(RDM_ST_ThunderAero)]
                [CustomComboInfo("促进选项", "在无赤x火/赤x石时自动插入促进.", RDM.JobID, 211)]
                RDM_ST_ThunderAero_Accel = 13211,

                    [ParentCombo(RDM_ST_ThunderAero_Accel)]
                    [CustomComboInfo("对单目标时使用即刻咏唱 设置", "没有连续咏唱/促进时插入即刻咏唱.", RDM.JobID, 212)]
                    RDM_ST_ThunderAero_Accel_Swiftcast = 13212,

            [ParentCombo(RDM_ST_DPS)]
            [CustomComboInfo("赤x火/赤x石选项 ", "将摇荡替换为赤x火/赤x石.", RDM.JobID,220)]
            RDM_ST_FireStone = 13220,

            [ParentCombo(RDM_ST_DPS)]
            [CustomComboInfo("能力技插入选项Weave oGCD Damage Option", "Weave the following oGCD actions.", RDM.JobID, 240)]
            RDM_ST_oGCD = 13240,

            [ParentCombo(RDM_ST_DPS)]
            [CustomComboInfo("单目标近战连击 Option", "Add the Reposte combo.\n**在近战连击前必须移动到近战范围内或插入短兵相接**", RDM.JobID, 410)]
            RDM_ST_MeleeCombo = 13410,

                [ParentCombo(RDM_ST_MeleeCombo)]
                [CustomComboInfo("倍增与鼓励使用 设置", "Add Manafication and Embolden.\n**在近战连击前必须移动到近战范围内或插入短兵相接***", RDM.JobID, 411)]
                RDM_ST_MeleeCombo_ManaEmbolden = 13411,

                    [ParentCombo(RDM_ST_MeleeCombo_ManaEmbolden)]
                    [CustomComboInfo("倍增与鼓励延后使用 设置", "延后这两个能力技，直到你能打出两次近战三连.", RDM.JobID, 412)]
                    RDM_ST_MeleeCombo_ManaEmbolden_DoubleCombo = 13412,

                [ParentCombo(RDM_ST_MeleeCombo)]
                [CustomComboInfo("使用短兵相接接近目标 设置", "有足够的魔元打出近战三连时，使用短兵相接接近目标.", RDM.JobID, 430)]
                RDM_ST_MeleeCombo_CorpsGapCloser = 13430,

                [ParentCombo(RDM_ST_MeleeCombo)]
                [CustomComboInfo("不平衡魔元处理 设置", "在开始近战连击前使用促进来平衡魔元.", RDM.JobID, 410)]
                RDM_ST_MeleeCombo_UnbalanceMana = 13440,

            [ParentCombo(RDM_ST_DPS)]
            [CustomComboInfo("近战三连结束后选项", "插入赤核爆/赤神圣.", RDM.JobID, 510)]
        ...
        */
        ...
        SGE_AoE_DPS = 14200,
            ...
            [CustomComboInfo("箭毒 无发炎层数时选项", "Use Toxikon when out of Phlegma charges.\nTakes priority over Dyskrasia.", SGE.JobID, 210, "", "")]
            SGE_AoE_DPS_NoPhlegmaToxikon = 14210,

            [ParentCombo(SGE_AoE_DPS)]
            [CustomComboInfo("箭毒 超出发炎范围时选项", "Use Toxikon when out of Phlemga's Range.\nTakes priority over Dyskrasia.", SGE.JobID, 220, "", "")]
        ...
        SAM_ST_GekkoCombo = 15003,
            ...
            [ParentCombo(SAM_ST_GekkoCombo)]
            [CustomComboInfo("雪风连击加入循环", "添加 Yukikaze combo to main combo. Will add Yukikaze during Meikyo Shisui as well", SAM.JobID, 0, "", "")]
            ...
            SAM_ST_GekkoCombo_CDs = 15099,
                ...
                [CustomComboInfo("将意气冲天加入循环", "添加 Ikishoten when at or below 50 Kenki.\nWill dump Kenki at 10 seconds left to allow Ikishoten to be used.", SAM.JobID, 0, "", "")]
                SAM_ST_GekkoCombo_CDs_Ikishoten = 15009,

                [ParentCombo(SAM_ST_GekkoCombo_CDs)]
                [CustomComboInfo("将居合术加入循环", "添加 Midare: Setsugekka, Higanbana, and Kaeshi: Setsugekka when ready and when you're not moving to main combo.", SAM.JobID, 0, "", "")]
        ...
        SAM_AoE_MangetsuCombo = 15020,
            ...
            [ParentCombo(SAM_AoE_MangetsuCombo)]
            [CustomComboInfo("意气冲天 添加到 满月 连击", "添加 Ikishoten when at or below 50 Kenki.\nWill dump Kenki at 10 seconds left to allow Ikishoten to be used.", SAM.JobID, 0, "", "")]
        ...
        [CustomComboInfo("樱花双目标功能", "添加 the Yukikaze combo, Mangetsu combo, Senei, Shinten, and Shoha to Oka combo.\nUsed for two targets only and when Lv86 and above.", SAM.JobID, 0, "", "")]
        ...
        [ParentCombo(SAM_ST_GekkoCombo)]
        [CustomComboInfo("回复设置", "添加 Bloodbath and Second Wind to the combo, using them when below the HP Percentage threshold.", SAM.JobID, 0, "", "")]
        ...
        */
        ...
        SCH_AoE_Heal = 16250,
            ...
            [CustomComboInfo("不屈不挠之策 独立选项", "Only uses Aetherflow if Indomitability is ready to use.", SCH.JobID)]
        ...
        [CustomComboInfo("亚灵神替换", "添加 Deathflare, Ahk Morn and Revelation to the single target and AoE combos.", SMN.JobID, 11, "", "")]
        SMN_Advanced_Combo_DemiSummons_Attacks = 17002,

        [ParentCombo(SMN_Advanced_Combo)]
        [CustomComboInfo("宝石耀&宝石辉替换", "添加 Gemshine and Precious Brilliance to the single target and AoE combos, respectively.", SMN.JobID, 4, "", "")]
        ...
        [CustomComboInfo("亚神技能替换亚神召唤", "添加 Enkindle Bahamut, Enkindle Phoenix and Astral Flow to their relevant summons.", SMN.JobID, 11, "", "")]
        ...
        [CustomComboInfo("兽魂监控", "如果你的兽魂量谱即将过量，并且在一个能产生兽魂量谱的连击技能之前，用消耗量谱的技能取代单目标或AOE整合。", WAR.JobID, 0, "", "")]
        ...
        [CustomComboInfo("猛攻", "Uses Onslaught when under Surging Tempest and in the target ring (1 yalm) and when not moving.\nWill use as many stacks as selected in the above slider.", WAR.JobID, 0, "", "")]
        ...
        WHM_ST_MainCombo = 19099,
            ...
            [ParentCombo(WHM_ST_MainCombo)]
            [CustomComboInfo("保持dot不断 设置", "添加 Aero/Dia to the single target combo if the debuff is not present on current target, or is about to expire.", WHM.JobID, 12, "", "")]
        ...
        [CustomComboInfo("医济功能", "低于50级时用医治替换医济", WHM.JobID, 60, "", "")]
        WHM_Medica = 19007,

            [ParentCombo(WHM_Medica)]
            [CustomComboInfo("狂喜之心 设置", "在狂喜之心可用时加入治疗循环.", WHM.JobID, 61, "", "")]
            WHM_Medica_Rapture = 19011,

            [ParentCombo(WHM_Medica)]
            [CustomComboInfo("苦难之心 设置", "在苦难之心可用时加入治疗循环.", WHM.JobID, 62, "", "")]
            WHM_Medica_Misery = 19010,

            [ParentCombo(WHM_Medica)]
            [CustomComboInfo("Thin Air Option", "添加 Thin Air when available.", WHM.JobID, 63, "", "")]
        ...
        [CustomComboInfo("Double Cast Option", "添加 Double Cast to Burst Mode.", AST.JobID)]
        ASTPvP_DoubleCast = 111001,

        [ParentCombo(ASTPvP_Burst)]
        [CustomComboInfo("Card Option", "添加 Drawing and Playing Cards to Burst Mode.", AST.JobID)]
        ASTPvP_Card = 111002,

        [SecretCustomCombo]
        [CustomComboInfo("Double Cast Heal Feature", "添加 Double Cast to Aspected Benefic.", AST.JobID)]
        ASTPvP_Heal = 111003,
        ...
        [SecretCustomCombo]
        [CustomComboInfo("Night Wing Option", "添加 Night Wing to Burst Mode.", BLM.JobID)]
        ...
        [CustomComboInfo("刃舞选项", "添加 Honing Dance to the main combo when in melee range (respects global offset).\nThis option prevents early use of Honing Ovation!\nKeep Honing Dance bound to another key if you want to end early.", DNC.JobID)]
        DNCPvP_BurstMode_HoningDance = 114001,

        [SecretCustomCombo]
        [ParentCombo(DNCPvP_BurstMode)]
        [CustomComboInfo("治疗之华尔兹选项", "添加 Curing Waltz to the combo when available, and your HP is at or below the set percentage.", DNC.JobID)]
        ...
        #region DARK KNIGHT
        [SecretCustomCombo]
        [CustomComboInfo("爆发模式", "将噬魂斩连击变成一个多合一的伤害按钮。", DRK.JobID)]
        DRKPvP_Burst = 115000,

        [SecretCustomCombo]
        [ParentCombo(DRKPvP_Burst)]
        [CustomComboInfo("Plunge Option", "添加 Plunge to Burst Mode.", DRK.JobID)]
        ...
        [SecretCustomCombo]
        [ParentCombo(DRKPvP_Burst)]
        [CustomComboInfo("腐秽大地 设置", "添加 Salted Earth to Burst mode.", DRK.JobID)]
        ...
        [CustomComboInfo("Geirskogul Option", "添加 Geirskogul to Burst Mode.", DRG.JobID)]
        DRGPvP_Geirskogul = 116001,

        [ParentCombo(DRGPvP_Geirskogul)]
        [CustomComboInfo("Nastrond Option", "添加 Nastrond to Burst Mode.", DRG.JobID)]
        DRGPvP_Nastrond = 116002,

        [ParentCombo(DRGPvP_Burst)]
        [CustomComboInfo("Horrid Roar Option", "添加 Horrid Roar to Burst Mode.", DRG.JobID)]
        DRGPvP_HorridRoar = 116003,

        [ParentCombo(DRGPvP_Burst)]
        [CustomComboInfo("Sustain Chaos Spring Option", "添加 Chaos Spring to Burst Mode when below the set HP percentage.", DRG.JobID)]
        DRGPvP_ChaoticSpringSustain = 116004,

        [ParentCombo(DRGPvP_Burst)]
        [CustomComboInfo("天龙点睛选项", "添加 Wyrmwind Thrust to Burst Mode.", DRG.JobID)]
        DRGPvP_WyrmwindThrust = 116006,

        [ParentCombo(DRGPvP_Burst)]
        [CustomComboInfo("High Jump Weave Option", "添加 High Jump to Burst Mode.", DRG.JobID)]
        ...
        [CustomComboInfo("倍攻", "添加 Double Down to Burst Mode while under the No Mercy buff.", GNB.JobID)]
        GNBPvP_DoubleDown = 117001,

        [SecretCustomCombo]
        [CustomComboInfo("Gnashing Fang Continuation Feature", "添加 Continuation onto Gnashing Fang.", GNB.JobID)]
        GNBPvP_GnashingFang = 117002,

        [ParentCombo(GNBPvP_Burst)]
        [CustomComboInfo("Draw And Junction Option", "添加 Draw And Junction to Burst Mode.", GNB.JobID)]
        GNBPvP_DrawAndJunction = 117003,

        [ParentCombo(GNBPvP_Burst)]
        [CustomComboInfo("Gnashing Fang Option", "添加 Gnashing Fang to Burst Mode while under the No Mercy buff.", GNB.JobID)]
        GNBPvP_ST_GnashingFang = 117004,

        [ParentCombo(GNBPvP_Burst)]
        [CustomComboInfo("Continuation Option", "添加 Continuation to Burst Mode.", GNB.JobID)]
        ...
        [ParentCombo(GNBPvP_Burst)]
        [CustomComboInfo("Junction Cast DPS Option", "添加 Junction Cast (DPS) to Burst Mode.", GNB.JobID)]
        GNBPvP_JunctionDPS = 117007,

        [ParentCombo(GNBPvP_Burst)]
        [CustomComboInfo("Junction Cast Healer Option", "添加 Junction Cast (Healer) to Burst Mode.", GNB.JobID)]
        GNBPvP_JunctionHealer = 117008,

        [ParentCombo(GNBPvP_Burst)]
        [CustomComboInfo("Junction Cast Tank Option", "添加 Junction Cast (Tank) to Burst Mode.", GNB.JobID)]
        ...
        [SecretCustomCombo]
        [CustomComboInfo("Thunderclap Option", "添加 Thunderclap to Burst Mode when not buffed with Wind Resonance.", MNK.JobID)]
        MNKPvP_Burst_Thunderclap = 119001,

        [ParentCombo(MNKPvP_Burst)]
        [SecretCustomCombo]
        [CustomComboInfo("Riddle of Earth Option", "添加 Riddle of Earth and Earth's Reply to Burst Mode when in combat.", MNK.JobID)]
        ...
        #region PALADIN
        [SecretCustomCombo]
        [CustomComboInfo("爆发模式", "Turns Royal Authority Combo into an all-in-one damage button.", PLD.JobID)]
        PLDPvP_Burst = 121000,

        [ParentCombo(PLDPvP_Burst)]
        [CustomComboInfo("Shield Bash Option", "添加 Shield Bash to Burst Mode.", PLD.JobID)]
        PLDPvP_ShieldBash = 121001,

        [ParentCombo(PLDPvP_Burst)]
        [CustomComboInfo("Confiteor Option", "添加 Confiteor to Burst Mode.", PLD.JobID)]
        ...
        #region REAPER
        [SecretCustomCombo]
        [CustomComboInfo("爆发模式", "Turns Slice Combo into an all-in-one damage button.\nAdds Soul Slice to the main combo.", RPR.JobID)]
        RPRPvP_Burst = 122000,

        [SecretCustomCombo]
        [ParentCombo(RPRPvP_Burst)]
        [CustomComboInfo("斩首令选项", "添加 Death Warrant onto the main combo when Plentiful Harvest is ready to use, or when Plentiful Harvest's cooldown is longer than Death Warrant's.\nRespects Immortal Sacrifice Pooling Option.", RPR.JobID)]
        ...
        [SecretCustomCombo]
        [ParentCombo(RPRPvP_Burst)]
        [CustomComboInfo("夜游魂衣爆发选项", "添加 Lemure's Slice to the main combo during the Enshroud burst phase.\nContains burst options.", RPR.JobID)]
        ...
        [SecretCustomCombo]
        [ParentCombo(RPRPvP_Burst_Enshrouded)]
        [CustomComboInfo("团契设置", "添加 Communio onto the main combo when you have 1 stack of Enshroud remaining.\nWill not trigger if you are moving.", RPR.JobID)]
        RPRPvP_Burst_Enshrouded_Communio = 122006,
        #endregion

        [SecretCustomCombo]
        [ParentCombo(RPRPvP_Burst)]
        [CustomComboInfo("远程收获月选项", "添加 Harvest Moon onto the main combo when you're out of melee range, the GCD is not rolling and it's available for use.", RPR.JobID)]
        RPRPvP_Burst_RangedHarvest = 122007,

        [SecretCustomCombo]
        [ParentCombo(RPRPvP_Burst)]
        [CustomComboInfo("Arcane Crest Option", "添加 Arcane Crest to the main combo when under the set HP perecentage.", RPR.JobID)]
        ...
        [CustomComboInfo("Pneuma Option", "添加 Pneuma to Burst Mode.", SGE.JobID)]
        ...
        #region Burst Mode
        [SecretCustomCombo]
        [CustomComboInfo("爆发模式", "添加 Meikyo Shisui, Midare: Setsugekka, Ogi Namikiri, Kaeshi: Namikiri and Soten to Meikyo Shisui.\nWill only cast Midare: Setsugekka and Ogi Namikiri when you're not moving.\nWill not use if target is guarding.", SAM.JobID)]
        SAMPvP_BurstMode = 125000,

            [SecretCustomCombo]
            [ParentCombo(SAMPvP_BurstMode)]
            [CustomComboInfo("Chiten Option", "添加 Chiten to Burst Mode when in combat and HP is below 95%.", SAM.JobID)]
            SAMPvP_BurstMode_Chiten = 125001,

            [SecretCustomCombo]
            [ParentCombo(SAMPvP_BurstMode)]
            [CustomComboInfo("Mineuchi Option", "添加 Mineuchi to Burst Mode.", SAM.JobID)]
            SAMPvP_BurstMode_Stun = 125002,

            [SecretCustomCombo]
            [ParentCombo(SAMPvP_BurstMode)]
            [CustomComboInfo("Burst Mode on Kasha Combo Option", "爆发模式加入花车连击", SAM.JobID, 1)]
        ...
        SAMPvP_KashaFeatures = 125004,
            ...
            [CustomComboInfo("使用必杀剑·早天拉近距离", "添加 Soten to the Kasha Combo when out of melee range.", SAM.JobID)]
        ...
        [CustomComboInfo("Expedient Option", "添加 Expedient to Burst Mode to empower Biolysis.", SCH.JobID)]
        SCHPvP_Expedient = 126001,

        [ParentCombo(SCHPvP_Burst)]
        [CustomComboInfo("Biolysis Option", "添加 Biolysis use on cooldown to Burst Mode.", SCH.JobID)]
        SCHPvP_Biolysis = 126002,

        [ParentCombo(SCHPvP_Burst)]
        [CustomComboInfo("Deployment Tactics Option", "添加 Deployment Tactics to Burst Mode when available.", SCH.JobID)]
        ...
        #region SUMMONER
        [SecretCustomCombo]
        [CustomComboInfo("爆发模式", "Turns Ruin III into an all-in-one damage button.\nOnly uses Crimson Cyclone when in melee range.", SMNPvP.JobID)]
        SMNPvP_BurstMode = 127000,

        [SecretCustomCombo]
        [ParentCombo(SMNPvP_BurstMode)]
        [CustomComboInfo("守护之光选项", "添加 Radiant Aegis to Burst Mode when available, and your HP is at or below the set percentage.", SMNPvP.JobID)]
        ...
        [SecretCustomCombo]
        [ParentCombo(WARPvP_BurstMode)]
        [CustomComboInfo("献身选项", "Removes Blota from Burst Mode if Primal Rend has 5 seconds or less on its cooldown.", WARPvP.JobID)]
        ...
        [CustomComboInfo("Misery Option", "添加 Afflatus Misery to Burst Mode.", WHM.JobID)]
        WHMPvP_Afflatus_Misery = 129001,

        [ParentCombo(WHMPvP_Burst)]
        [CustomComboInfo("Miracle of Nature Option", "添加 Miracle of Nature to Burst Mode.", WHM.JobID)]
        WHMPvP_Mirace_of_Nature = 129002,

        [ParentCombo(WHMPvP_Burst)]
        [CustomComboInfo("Seraph Strike Option", "添加 Seraph Strike to Burst Mode.", WHM.JobID)]
        WHMPvP_Seraph_Strike = 129003,

        [SecretCustomCombo]
        [CustomComboInfo("Aquaveil Feature", "添加 Aquaveil to Cure II when available.", WHM.JobID)]
        WHMPvP_Aquaveil = 129004,

        [SecretCustomCombo]
        [CustomComboInfo("Cure III Feature", "添加 Cure III to Cure II when available.", WHM.JobID)]
        WHMPvP_Cure3 = 129005,
