...
public class Translatezh_CN
{
    public static Dictionary<string, string> db = new()
    {
        ...
        { "Adds The Arrow (increased healing) when the card has been drawn", "抽到卡牌时添加箭矢（增加治疗效果）。" },
        ...
        { "Adds Radiant Finale to the Buffs feature.", "将辉煌终曲添加到增益功能中。" },
        { "Encore Option", "安可选项" },
        ...
        { "Adds enemy health checking on targeted mob for songs.\nThey will not be reapplied if less than specified.", "对目标敌人的生命值进行检查，为歌曲效果。\n如果生命值低于指定值，则不会重新应用。" },
        ...
        { "Tetragrammaton Option", "四星圣印选项" },
        { "Uses Tetragrammaton when available.", "可用时使用四星圣印。" },
