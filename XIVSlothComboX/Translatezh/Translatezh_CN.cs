...
public class Translatezh_CN
{
    ...
    { 
        ...
        {"Replaces Doom Spike with a full one-button AoE rotation.\nThis is the ideal option for newcomers to the job." , "用一个全键AoE旋转替换末日尖刺。\n这是新手的理想选择。"  },
        ...
        {"Adds Hot Shot/Air Anchor to the rotation." , "[AI]将热火/空中锚添加到旋转中。"  },
        {"Reassemble Option" , "[AI]重新组装选项"  },
        {"Adds Reassemble to the rotation." , "[AI]将重新组装添加到旋转中。"  },
        {"Gauss Round / Ricochet Option" , "[AI]高斯圆/跳弹选项"  },
        {"Adds Gauss Round and Ricochet to the rotation.\nWill prevent overcapping.", "[AI]将高斯圆和跳弹添加到旋转中。\n将防止过度堆积。"  },
        {"Hypercharge Option" , "[AI]超荷"  },
        {"Adds Hypercharge to the rotation." , "[AI]将超荷添加到旋转中。"  },
        {"Heat Blast Option" , "[AI]热爆选项"  },
        {"Adds Heat Blast to the rotation" , "[AI]将热爆添加到旋转中"  },
        {"Rook Autoturret/Automaton Queen Option" , "[AI]车前塔/机械女王选项"  },
        {"Adds Rook Autoturret/Automaton Queen to the rotation." , "[AI]将车前塔/机械女王添加到旋转中。"  },
        {"Wildfire Option" , "[AI]野火 设置"  },
        {"Adds Wildfire to the rotation." , "[AI]将野火添加到旋转中。"  },
        {"Drill option" , "[AI]钻头选项"  },
        {"Adds Drill to the rotation." , "[AI]将钻头添加到旋转中。"  },
        {"Barrel Stabilizer Option" , "[AI]枪管稳定器选项"  },
        {"Adds Barrel Stabilizer to the rotation." , "[AI]将枪管稳定器添加到旋转中。"  },
        {"Wildfire Only Option" , "[AI]在特定时机插入"  },
        {"Only use Barrel Stabilizer to prepare for Wildfire." , "[AI]仅使用枪管稳定器准备野火。"  },
        {"Chain Saw option" , "[AI]链锯选项"  },
        {"Adds Chain Saw to the rotation." , "[AI]将链锯添加到旋转中。"  },
        {"Head Graze Option" , "[AI]头部擦伤选项"  },
        {"Uses Head Graze to interrupt during the rotation, where applicable." , "[AI]在适当的情况下使用头部擦伤来打断旋转。"  },
        {"Second Wind Option" , "[AI]内丹选项"  },
        ...
        {"Adds Bloodbath and Second Wind to the combo, using them when below the HP Percentage threshold." , "[AI]将吸血和第二道风添加到连击中，在生命值低于百分比阈值时使用。"  },
        #endregion
        #region NINJA
