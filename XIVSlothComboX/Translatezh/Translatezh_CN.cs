...
public class Translatezh_CN
{
    ...
    { 
        ...
        {"Adds Reassemble to the rotation." , "[AI]将重新组装添加到循环中。"  },
        {"Gauss Round / Ricochet Option" , "[AI]虹吸弹/弹射选项"  },
        {"Adds Gauss Round and Ricochet to the rotation.\nWill prevent overcapping.", "[AI]将虹吸弹和弹射添加到循环中。\n将防止过度堆积。"  },
        {"Hypercharge Option" , "超荷"  },
        {"Adds Hypercharge to the rotation." , "将超荷添加到旋转中。"  },
        {"Heat Blast Option" , "热冲击选项"  },
        {"Adds Heat Blast to the rotation" , "将热冲击加到旋转中"  },
        {"Rook Autoturret/Automaton Queen Option" , "车前塔/机械女王选项"  },
