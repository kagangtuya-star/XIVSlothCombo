...
namespace XIVSlothComboX.Combos.PvE
{
    internal class RDM
    {
        ...
        internal class RDM_ST_DPS : CustomCombo
        {
            ...
            internal static RDMHelper.RDMOpenerLogic RDMOpener = new();

            protected override uint Invoke(uint actionID, uint lastComboMove, float comboTime, byte level)
            {
                //MAIN_COMBO_VARIABLES

                int blackmana = RDMHelper.RDMMana.Black; //Gauge.BlackMana;
                int whitemana = RDMHelper.RDMMana.White; //Gauge.WhiteMana;
                ...
                {
                    //VARIANTS
                    if (IsEnabled(CustomComboPreset.RDM_Variant_Cure) && IsEnabled(Variant.VariantCure) && PlayerHealthPercentageHp() <= GetOptionValue(Config.RDM_VariantCure))
                        return Variant.VariantCure;

                    if (IsEnabled(CustomComboPreset.RDM_Variant_Rampart) && IsEnabled(Variant.VariantRampart) && IsOffCooldown(Variant.VariantRampart) && CanSpellWeave(actionID))
                ...
                if (IsEnabled(CustomComboPreset.RDM_ST_Lucid)
                    ...
                    && InCombat()
                    && RDMHelper.RDMLucid.SafetoUse(lastComboMove)) //Don't interupt certain combos
                ...
                if (IsEnabled(CustomComboPreset.RDM_ST_oGCD))
                {
                    bool ActionFound =
                        ...
                        || (Config.RDM_ST_oGCD_OnAction_Adv
                            && ((Config.RDM_ST_oGCD_OnAction[0] && actionID is Jolt or Jolt2 or Jolt3) || (Config.RDM_ST_oGCD_OnAction[1] && actionID is Fleche) || (Config.RDM_ST_oGCD_OnAction[2] && actionID is Riposte) || (Config.RDM_ST_oGCD_OnAction[3] && actionID is Reprise)
                            )
                        );

                    if (ActionFound && LevelChecked(Corpsacorps))
                    {
                        if (RDMHelper.OGCDHelper.CanUse(actionID, true, out uint oGCDAction)) return oGCDAction;
                    }
                }
                //END_RDM_OGCD
                ...
                {
                    bool ActionFound =
                        (!Config.RDM_ST_MeleeFinisher_Adv && actionID is Jolt or Jolt2 or Jolt3) || (Config.RDM_ST_MeleeFinisher_Adv && ((Config.RDM_ST_MeleeFinisher_OnAction[0] && actionID is Jolt or Jolt2 or Jolt3) || (Config.RDM_ST_MeleeFinisher_OnAction[1] && actionID is Riposte or EnchantedRiposte) || (Config.RDM_ST_MeleeFinisher_OnAction[2] && actionID is Veraero or Veraero3 or Verthunder or Verthunder3)));

                    if (ActionFound && RDMHelper.MeleeFinisher.CanUse(lastComboMove, out uint finisherAction))
                ...
                {
                    bool ActionFound =
                        (!Config.RDM_ST_MeleeCombo_Adv && (actionID is Jolt or Jolt2 or Jolt3)) || (Config.RDM_ST_MeleeCombo_Adv && ((Config.RDM_ST_MeleeCombo_OnAction[0] && actionID is Jolt or Jolt2 or Jolt3) || (Config.RDM_ST_MeleeCombo_OnAction[1] && actionID is Riposte or EnchantedRiposte)));
                    ...
                    if (ActionFound)
                    {
                            ...
                            && (GetTargetDistance() <= 3 || (IsEnabled(CustomComboPreset.RDM_ST_MeleeCombo_CorpsGapCloser) && HasCharges(Corpsacorps))))
                        {
                            ...
                            if (IsEnabled(CustomComboPreset.RDM_ST_MeleeCombo_ManaEmbolden_DoubleCombo)
                                ...
                                && RDMHelper.RDMMana.Max >= 57
                                && RDMHelper.RDMMana.Min >= 46
                            ...
                            if (IsEnabled(CustomComboPreset.RDM_ST_MeleeCombo_ManaEmbolden_DoubleCombo)
                                && level >= 90
                                && (RDMHelper.RDMMana.ManaStacks == 0 || RDMHelper.RDMMana.ManaStacks == 3)
                                && lastComboMove is not Verflare
                                && lastComboMove is not Verholy
                                && lastComboMove is not Scorch
                                && RDMHelper.RDMMana.Max <= 50
                            ...
                            if (!LevelChecked(Manafication) && ActionReady(Embolden) && RDMHelper.RDMMana.Min >= 50)
                            {
                                return Embolden;
                            }
                        ...
                        if (((RDMHelper.RDMMana.Min >= 50 && LevelChecked(Redoublement))
                             || (RDMHelper.RDMMana.Min >= 35 && !LevelChecked(Redoublement))
                             || (RDMHelper.RDMMana.Min >= 20 && !LevelChecked(Zwerchhau)))
                            && !HasEffect(Buffs.Dualcast))
                        {
                                ...
                                && !HasEffect(Buffs.Embolden))
                            {
                                if (HasEffect(Buffs.Acceleration) || WasLastAction(Buffs.Acceleration))
                                {
                                    ...
                                    var actions = RDMHelper.RDMMana.CheckBalance();
        ...
        internal class RDM_AoE_DPS : CustomCombo
        {
            ...
            protected override uint Invoke(uint actionID, uint lastComboMove, float comboTime, byte level)
            {
                ...
                if (IsEnabled(CustomComboPreset.RDM_AoE_Lucid)
                    ...
                    && InCombat()
                    && RDMHelper.RDMLucid.SafetoUse(lastComboMove))
                    return All.LucidDreaming;
                ...
                if (IsEnabled(CustomComboPreset.RDM_AoE_oGCD)
                    && LevelChecked(Corpsacorps)
                    && actionID is Scatter or Impact
                    && RDMHelper.OGCDHelper.CanUse(actionID, false, out uint oGCDAction)) return oGCDAction;

                //RDM_MELEEFINISHER
                if (IsEnabled(CustomComboPreset.RDM_AoE_MeleeFinisher))
                {
                    bool ActionFound =
                        (!Config.RDM_AoE_MeleeFinisher_Adv && actionID is Scatter or Impact) || (Config.RDM_AoE_MeleeFinisher_Adv && ((Config.RDM_AoE_MeleeFinisher_OnAction[0] && actionID is Scatter or Impact) || (Config.RDM_AoE_MeleeFinisher_OnAction[1] && actionID is Moulinet) || (Config.RDM_AoE_MeleeFinisher_OnAction[2] && actionID is Veraero2 or Verthunder2)));
                ...
                {
                    bool ActionFound =
                        (!Config.RDM_AoE_MeleeCombo_Adv && actionID is Scatter or Impact) || (Config.RDM_AoE_MeleeCombo_Adv && ((Config.RDM_AoE_MeleeCombo_OnAction[0] && actionID is Scatter or Impact) || (Config.RDM_AoE_MeleeCombo_OnAction[1] && actionID is Moulinet)));
                    ...
                    if (ActionFound)
                    {
                        ...
                        if (IsEnabled(CustomComboPreset.RDM_AoE_MeleeCombo_ManaEmbolden))
                        {
                            if (HasCondition(ConditionFlag.InCombat)
                                ...
                                && !HasEffect(All.Buffs.Swiftcast)
                                && !HasEffect(Buffs.Acceleration)
                                && ((GetTargetDistance() <= Config.RDM_AoE_MoulinetRange && RDMHelper.RDMMana.ManaStacks == 0) || RDMHelper.RDMMana.ManaStacks > 0))
                            {
                                if (ActionReady(Manafication))
                                {
                                    //Situation 1: Embolden First (Double)
                                    if (RDMHelper.RDMMana.ManaStacks == 2
                                        && RDMHelper.RDMMana.Min >= 22
                                        && IsOffCooldown(Embolden))
                                    {
                                        return Embolden;
                                    }
                                    if (((RDMHelper.RDMMana.ManaStacks == 3 && RDMHelper.RDMMana.Min >= 2) || (RDMHelper.RDMMana.ManaStacks == 0 && RDMHelper.RDMMana.Min >= 10))
                                        && lastComboMove is not Verflare
                                        && lastComboMove is not Verholy
                                        && lastComboMove is not Scorch
                                        && RDMHelper.RDMMana.Max <= 50
                                    ...
                                    if (RDMHelper.RDMMana.ManaStacks == 0
                                        && lastComboMove is not Verflare
                                        && lastComboMove is not Verholy
                                        && lastComboMove is not Scorch
                                        && RDMHelper.RDMMana.Max <= 50
                                        && RDMHelper.RDMMana.Min >= 10
                                        && IsOffCooldown(Embolden))
                                    {
                                        return Embolden;
                                    }
                            ...
                            && RDMHelper.RDMMana.Min >= 50)
                        {
                            ...
                            if ((GetTargetDistance() <= Config.RDM_AoE_MoulinetRange && RDMHelper.RDMMana.ManaStacks == 0) || RDMHelper.RDMMana.ManaStacks >= 1)
                                return OriginalHook(Moulinet);
                        }
                    }
                }
        ...
        */
            ...
            protected override uint Invoke(uint actionID, uint lastComboMove, float comboTime, byte level)
            {
                if (actionID is All.Swiftcast)
                {
                    ...
                    if (LevelChecked(Verraise))
                    {
                        ...
                        if (IsEnabled(CustomComboPreset.RDM_Raise_Vercure) && !schwifty && ActionReady(Vercure) && IsOnCooldown(All.Swiftcast))
                            return Vercure;
                    }
        ...
        internal class RDM_EmboldenProtection : CustomCombo
        {
            ...
            protected override uint Invoke(uint actionID, uint lastComboMove, float comboTime, byte level) =>
                actionID is Embolden && ActionReady(Embolden) && HasEffectAny(Buffs.EmboldenOthers) ? OriginalHook(11) : actionID;
        }
        ...
        internal class RDM_MagickProtection : CustomCombo
        {
            ...
            protected override uint Invoke(uint actionID, uint lastComboMove, float comboTime, byte level) =>
                actionID is MagickBarrier && ActionReady(MagickBarrier) && HasEffectAny(Buffs.MagickBarrier) ? OriginalHook(11) : actionID;
        }
    }
}