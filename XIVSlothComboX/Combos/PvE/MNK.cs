...
namespace XIVSlothComboX.Combos.PvE
{
    internal class MNK
    {
        ...
        internal class MNK_ST_SimpleMode : CustomCombo
        {
            ...
            protected override uint Invoke(uint actionID, uint lastComboActionID, float comboTime, byte level)
            {
                ...
                if (actionID is Bootshine or LeapingOpo)
                {
                    ...
                    if (IsEnabled(Variant.VariantCure) && PlayerHealthPercentageHp() <= Config.MNK_VariantCure)
                    ...
                    {
                        if (IsEnabled(Variant.VariantRampart) && IsOffCooldown(Variant.VariantRampart))
        ...
        {
            protected internal override CustomComboPreset Preset { get; } = CustomComboPreset.MNK_STUseTheForbiddenChakra;
